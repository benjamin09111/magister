function plot_overlaps_vs_mo(results, cfg)
% Figura estilo paper: average number of overlaps (ALT vs MO)
...
for l_idx = 1:length(results.lambdas)
    ...
    plot(ax, results.n_range, results.mean_overlaps_alt(l_idx, :), ...
        'linestyle', '--', 'marker', 'o', ...
