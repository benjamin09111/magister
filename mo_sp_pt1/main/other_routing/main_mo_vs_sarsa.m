%% main_mo_vs_sarsa.m
% Comparación de Minimal Overlaps (MO) vs SARSA Standalone.
% Genera los mismos gráficos que main_experiments_control.m pero comparando con SARSA.
...
fprintf('\nCorriendo experimento general: SARSA vs MO...\n');
results = run_experiment_suite_vs_mo(cfg, @run_sarsa_routing, 'SARSA');

sched = struct();
% fprintf('\nCorriendo experimento de schedulability: SARSA vs MO...\n');
% sched = run_experiment_suite_schedulability_vs_mo(cfg, @run_sarsa_routing, 'SARSA');
...
if save_results
    out_path = fullfile(project_root, 'results_mo_vs_sarsa.mat');
