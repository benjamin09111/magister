function plot_sched_ratio_channels_vs_mo(sched, cfg)
% Schedulability ratio varying number of channels (ALT vs MO) - estilo paper
...
for m_idx = 1:length(sched.m_values)
    ...
    plot(ax, sched.n_range, sched.ratio_channels_alt(m_idx, :), ...
        'linestyle', '--', 'marker', 'o', ...
